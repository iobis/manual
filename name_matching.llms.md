...
![](images/WoRMS-taxaMatch-workflow.png)

Workflow for matching a list of taxon names to WoRMS
...
![](images/WoRMS_classification.png)

WoRMS classification box
...
![](images/WoRMS-resolve-ambiguousMatches.png)

Example of choices from an abiguous match
...
- Check that the species [is marine](common_qc.llms.md#non-marine-species)
