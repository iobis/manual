...
### [Using DuckDB to query the OBIS occurrence dataset - Part 2 (spatial extension)](tutorials/duckdb-part2/index.llms.md)

OBIS now has a occurrence dataset in GeoParquet format, but to work with large datasets you need the right tools. Here we explore how you can use DuckDB to (very) quickly retrieve data from this resource.

Sep 26, 2025

### [Using DuckDB to query the OBIS occurrence dataset - Part 3 (`duckplyr` package)](tutorials/duckdb-part3/index.llms.md)
...
### [Matching environmental information with OBIS occurrences](tutorials/env-data/index.llms.md)
