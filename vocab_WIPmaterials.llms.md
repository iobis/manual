...
*These materials I developed, but require review by the Vocab Task team before becoming public so I’ve moved them to this page* *When finalized, this material can be moved to the vocabulary page*
...
1.  For most measurements documented in OBIS, this will be “biological entity specified elsewhere” (*not* a specific species), a sub-group ([S13](https://vocab.nerc.ac.uk/search_nvs/S13/)) or a sub-component ([S12](https://vocab.nerc.ac.uk/search_nvs/S12/)). However it could be a chemical ([S27](https://vocab.nerc.ac.uk/search_nvs/S27/)) or physical object or a physical phenomenon (S18-S20). Sometimes the environmental matrix itself is the object of interest (e.g. pH of water body, atmospheric temperature).
