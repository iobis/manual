...
- Be compliant with the IOC data policy (<http://iode.org/policy>) and implementation guidelines from OBIS ([Data Policy](policy.llms.md)) with a 12 month grace period for achieving compliance after a Node is established
...
- Advise on how best to showcase and catalogue data and information products developed by the wider OBIS community, in line with the OBIS [Data Policy](policy.llms.md), including proper acknowledgment of other formats of resources (e.g. software applications, workflows, papers, etc.)
