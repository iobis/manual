...
*Screenshot indicating how to reserve a DOI for your dataset*
...
![](images/data-tracking.png)

*Example screenshot of how dataset downloads can be tracked*

## Update your data in OBIS

To update your own data in OBIS, the process is largely the same as [publishing your first version](ipt.llms.md#publish-on-the-ipt). Follow the steps below:
...
![](images/ipt-pubVersion.png)

*Example of IPT version control*
