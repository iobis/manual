...
Before we get into the details for accessing and using the IPT, let’s understand what it is. Biodiversity datasets and their metadata are published in OBIS using the Integrated Publishing Toolkit (IPT), developed by GBIF. The IPT is an open source web application that can be customized by the OBIS node manager (see [IPT admin page](ipt_admin.llms.md) for details). An IPT-instance is used to publish and register all datasets. To be able to create and manage your own dataset (called a “resource” by GBIF), you will need a user account. In general, the IPT software assists users in mapping data to valid Darwin Core terms, as well as archiving and compressing the Darwin Core content with:
...
2.  The `eml.xml` file, which contains the dataset metadata in [Ecological Metadata Language](https://en.wikipedia.org/wiki/Ecological_Metadata_Language) (EML) format. For instructions on how to enter the metadata go to [EML](eml.llms.md).
...
*Example showing how Occurrence core, EML, and meta.xml files make up a Darwin Core-Archive file*
...
![](images/ipt-login.png)

*Screenshot of IPT login page, highlighting link to IPT admin and the login button*

If you are an IPT admin and want to know how to set up an IPT yourself, see the [IPT admin page](ipt_admin.llms.md).
...
![](images/ipt-manageresources.png)

*Screenshot of the manage resources page on the IPT*
...
*Screenshot of where on the IPT page you can add source data*
...
*Screenshot of page shown after you upload a source file for the first time*
...
*Example screenshot of the different files, core and extensions, you can upload to an IPT*
...
![](images/ipt-ss4-dwcmap.png)

*Screenshot of the IPT demonstrating where to add new DwC mappings*
...
![](images/ipt-ss5-eventmap.png)

*Screenshot showing the two Core types you can map a datafile to*
...
![](images/ipt-ss12-metadata.png)

*Screenshot showing where to add or upload metadata*

Follow the guidelines on the [OBIS metadata standards and best practices](eml.llms.md) page, or check the [IPT manual](https://ipt.gbif.org/manual/en/ipt/latest/manage-resources#metadata) for detailed instructions about the metadata editor. You can also upload a file with metadata information. The video below ![](data:image/svg+xml;base64,) also demonstrates how to fill metadata on the IPT.
...
![](images/ipt-ss7-pub.png)

*Screenshot showing where to manage the publishing of your dataset*
...
![](images/ipt-ss9-vis.png)

*Screenshot showing how to change the visibility of your dataset*

Your dataset will only be harvested by GBIF when you change Registration to Registered. This step is not needed for OBIS to harvest your datasets. Please do not register your dataset with GBIF if your dataset is already published in GBIF by another publisher. Note that the IPT itself must be [registered with GBIF](ipt_admin.llms.md) in order to publish to GBIF. The node manager can do this.

![](images/ipt-ss8-gbifreg.png)

*Screenshot showing where to register your dataset with GBIF. This is only available if the IPT itself is registered with GBIF as well.*
...
The first minute of the video below ![](data:image/svg+xml;base64,) provides an overview of how to publish on the IPT.
...
![](images/ipt-ss10-download1.png)

*Overview of home page of an IPT*
...
![](images/ipt-ss11-download2.png)

*Overview of a dataset page on an IPT, emphasizing where to download the resource*
