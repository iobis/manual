...
We elaborate on how this structure is applied within OBIS [here](formatting.llms.md#dataset-structure).

![](images/relationalDB-updated.png)
...
*Example of how sample data is distributed to core and extension tables, and how these tables are connected in OBIS*
