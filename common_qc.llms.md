...
- If you have a set of points, lines, or polygons (perhaps from the Map tool), you can calculate a single representative coordinate and enter it into the `decimalLatitude` and `decimalLongitude` fields. [obistools::calculate_centroid](https://github.com/iobis/obistools#calculate-centroid-and-radius-for-wkt-geometries) returns the centroid of the shape’s convex hull, along with a `coordinateUncertaintyInMeters` large enough to cover the whole shape. Note that for concave or multi-part shapes (e.g., a crescent-shaped bay or a group of islands) this point can fall outside the shape itself. To get a point that is guaranteed to fall within the area, use PostGIS [ST_PointOnSurface](https://postgis.net/docs/ST_PointOnSurface.html), and calculate `coordinateUncertaintyInMeters` as the distance from that point to the farthest part of the shape.
...
![](images/getty-thesaurus-NZexample.png)

*Screenshot of Cook Strait page on the Getty Thersaurus*

For Google Maps, the coordinates can be found in the url after searching.

![](images/google-maps-coordinates.png)

*Screenshot of Google Maps showing where coordinates can be found in the URL*
...
![](images/marinegazeeteer-search.png) ![Marine regions gazetteer search](images/marinegazeeteer-bayfundy.png)
...
![Bay of Fundy source IHO](images/marinegazeeteer-bayfundy-1-IHO.png) ![Bay of Fundy source SeaVoX](images/marinegazeeteer-bayfundy-2-SeaVoX.png) ![Canadian part of Bay of Fundy source Marine Region](images/marinegazeeteer-bayfundy-3-MarRegion.png) ![Bay of Fundy source MEOW](images/marinegazeeteer-bayfundy-4-MEOW.png) ![United States part of Bay of Fundy source Marine Region](images/marinegazeeteer-bayfundy-5-MarRegion.png)
...
![](images/MarineRegions-Gazetteer_placedetails.png)

*Screenshot of Marine Region placedetails, highlighting important information for OBIS*
...
The OBIS Mapper has built-in access to the Marine Regions Gazetteer. The video ![](data:image/svg+xml;base64,) below demonstrates how to use this built-in tool, as well as how to navigate the Marine Regions Gazetter to obtain important georeferencing information to include in your data.
...
If the provided name is unaccepted in WoRMS, it is okay to use the unaccepted name in this field. `scientificNameID` should contain the [WoRMS LSID](name_matching.llms.md) for the genus.
...
![](images/fig1-openNomenclature.png)

*Figure 1. Flow diagram with the main Open Nomenclature qualifiers associated with physical specimens. The degree of confidence in the correct identifier increases from the top down. More info and figure copied from [Open Nomenclature in the biodiversity era](https://doi.org/10.1111/2041-210X.12594).*

![](images/fig2-flowDiagram.jpg)
...
![](images/dropped-records1.png)

*Dropped records from a benthic macroalgae dataset*
...
![](images/dropped-records2.png)

*Flags specifying why certain records were dropped*
...
![](images/nonmarine-spp-worms.png)
