...
That is it, now you can work with the spatial extension of DuckDB! In the [next tutorial](%7B%7B%3C%20ref%20%22tutorials/duckdb-part3/index.md%22%20%3E%7D%7D) we will explore the R package [`duckplyr`](https://duckplyr.tidyverse.org/index.html), a drop-in replacement for DuckDB on R which uses the `tidyverse` grammar.
