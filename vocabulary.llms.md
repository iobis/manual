...
- [Map eMoF measurement identifiers](#map-emof-measurement-identifiers-to-preferred-vocabulary)
  ...
  - [Vocabulary decision tree](vocab_tree.llms.md)
...
- Handle for publications on IOC’s [Ocean Best Practices repository](http://www.oceanbestpractices.net/), e.g. <http://hdl.handle.net/11329/304>
...
![](images/P01semantic-model.png)

*The elements underlying the P01 semantic model*
...
![](images/P01_wheel.png)

*The P01 wheel, demonstrating how P01 elements are represented by other NVS collections*
...
Click the [decision tree](vocab_tree.llms.md) below to help you select P01 codes for biological, chemical, physical, and/or sampling measurements. See the [OBIS YouTube Vocabulary series](https://www.youtube.com/playlist?list=PLlgUwSvpCFS4hADB7Slf44V1KJauEU6Ul) ![](data:image/svg+xml;base64,) for guidance on how to use this tree and examples for different types of `measurementTypeIDs`. The tree also helps identify vocabulary collections for `measurementUnitID` and non-numeric `measurementValueID`.

[![](images/vocab-decision-tree.png)](vocab_tree.llms.md)

*Decision tree to assist with finding and selecting appropriate controlled vocabulary to be used in the eMoF. Click the tree to be directed to a larger page.*
