...
<style>
h1.title {
    font-weight: 600; font-size: 2.5rem; color: #1e74ac;
}
</style>
```
...
The OBIS manual is a dynamic document and is revised on a regular basis. We welcome suggestions for additions and changes, which can be sent to [helpdesk@obis.org](mailto:helpdesk@obis.org), the OBIS Capacity Development Task Team at [training@obis.org](mailto:training@iobis.org), and/or submitted as issues at <https://github.com/iobis/manual/issues>. You can also [download this manual as a PDF](https://manual.obis.org/The-OBIS-manual.pdf).
